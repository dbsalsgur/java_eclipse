	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae_type.equals(search.getText())) {
			...
			try {
				...
				crVO = new CrimeRecordVO(crimNo, rcombo.getSelectedIndex(), scombo.getSelectedIndex(), crcombo.getSelectedIndex(), answerF[0].getText().trim(), regitNumInput, answerF[2].getText().trim(), ctgycombo.getSelectedIndex());
				crDAO = new CriminalDAO();
